...
public class TimelineAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String years = list.get(position).get("years").toString();
		int  imgs =(Integer) list.get(position).get("imgs");
		viewHolder.title.setText(titleStr);
		viewHolder.year.setText(years);
		viewHolder.img.setImageResource(imgs);
		return convertView;
	}
